...
def fitness_prob(population, problem):
    ...
    for i in range(0, len(population)):
        total_dist_all_individuals.append(total_dist_individual(population[i], problem))
...
def findBestOffspring(population):
    ...
    return population[index_minimum]
...
def solution(populationStart, n_generations, mutation_per):
    """
        ...
        """
    population = initial_population(populationStart, n_population=200)
    ...
    for i in range(n_generations):
        ...
        print(next_best)
        print(total_dist_individual(next_best, problem))
...
# weights_matrix(problem)
# print(problem)

best = solution(cities, 300, 0.7)
print(best)
print(total_dist_individual(best, problem))
